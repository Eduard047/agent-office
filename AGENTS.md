...
- This is a lightweight web app that visualizes AI agents as people working in a calm virtual office.
- Keep the interface simple, warm, and approachable: light cream surfaces, natural wood, sage, dusty blue, and terracotta.
- Avoid cybernetic, command-center, sci-fi, neon, telemetry-heavy, or dense-dashboard styling.
